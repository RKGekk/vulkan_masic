...
enum class WindowKey : unsigned char {
	...
	OemEq = 0xbb, // For any country/region, the '+=' key
	OemComma = 0xbc, // For any country/region, the ',' key
	OemMinus = 0xbd, // For any country/region, the '-_' key
	OemUnderscore = 0xbd, // For any country/region, the '-_' key
	...
	OemSlash = 0xbf, // Used for miscellaneous characters; it can vary by keyboard. For the US standard keyboard, the '/?' key
	...
	OemGraveAccent = 0xc0, // Used for miscellaneous characters; it can vary by keyboard. For the US standard keyboard, the '`~' key
