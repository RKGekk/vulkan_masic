...
EvtData_Window_Close::EvtData_Window_Close(std::string window_name, bool confirm_close) : m_confirm_close(confirm_close), m_window_name(window_name) {}
...
const std::string& EvtData_Window_Close::GetWindowName() {
