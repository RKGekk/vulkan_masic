...
struct BoundingOrientedBox {
    ...
    glm::quat Orientation;       // Unit quaternion representing rotation (box -> world).

    // Creators
    BoundingOrientedBox() noexcept : Center(0.0f, 0.0f, 0.0f), Extents(1.0f, 1.0f, 1.0f), Orientation(0.0f, 0.0f, 0.0, 1.0f) {}
    ...
    BoundingOrientedBox(const glm::vec3& center,const glm::vec3& extents, const glm::quat& orientation) noexcept : Center(center), Extents(extents), Orientation(orientation) {}

    // Methods
    void Transform(BoundingOrientedBox& Out, const glm::mat4x4& M) const noexcept;
    void Transform(BoundingOrientedBox& Out, float Scale, const glm::quat& Rotation, const glm::vec3& Translation) const noexcept;
    ...
    static void CreateFromPoints(BoundingOrientedBox& Out, size_t Count, const glm::vec3* pPoints, size_t Stride) noexcept;
};